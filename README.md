...
Usage examples are in a separate document that you will find here   Note that some usage examples will use the AGMPowerLib module, so also ensure you have that installed:
